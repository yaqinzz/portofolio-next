...
export default function Intro() {
  ...
  return (
    <section id="home" ref={ref} className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[50rem]">
      ...
      <motion.h1
        ...
        <span className="font-bold">Ahmad Ainul Yaqin.</span>
      </motion.h1>
      <motion.h4 className="mb-10 px-4 text-xl font-medium !leading-[1.5] sm:text-2xl" initial={{opacity: 0, y: 100}} animate={{opacity: 1, y: 0}}>
        experience in fullstack development, using <span className="font-bold">React JS and Express JS</span> for developing a website and web
        applications.
      ...
      <motion.div
        ...
        <a
          ...
          href="https://www.linkedin.com/in/ahmad-ainul-yaqin/"
          target="_blank">
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="mailto:ahmadainulyaqin131@gmail.com"
          target="_blank">
          <RiMailSendLine />
        </a>
        <a
          className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://github.com/yaqinzz"
          target="_blank">
          <FaGithubSquare />
        </a>
        {/* <a
