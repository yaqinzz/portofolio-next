...
export default function Skills() {
  ...
  return (
    <section id="skills" ref={ref} className="mb-28 max-w-[53rem] scroll-mt-28 text-center sm:mb-40">
      <div className="bg-emerald-400 absolute bottom-[-rem] -z-10 left-[-35rem] h-[31.25rem] w-[50rem] rounded-full blur-[10rem] sm:w-[68.75rem] md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem] dark:bg-[#676394]"></div>
        ...
        {skilss.map((skill, index) => (
          <div key={index} className="relative mt-5 flex justify-center">
            <motion.div
              ...
              <Image src={skill.imgUrl} alt="Bayu Maulana Ikhsan" width="192" height="192" quality="95" priority={true} className="md:w-16 w-6" />
              {/* <div
                className={`${
                  isHover &&
                  dataIndex === index &&
